(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".swiper-two")) {
            let swiperTwo = new swiper_core_Swiper(".swiper-two", {
            ...
            let intersectionObserver = new IntersectionObserver((entries => {
                entries.forEach((entry => {
                    if (entry.target.classList.contains("swiper-two")) if (entry.isIntersecting) swiperTwo.autoplay.start(); else swiperTwo.autoplay.stop();
                }));
            }));
            document.querySelectorAll(".swiper-two").forEach((swiperTwoElement => {
                intersectionObserver.observe(swiperTwoElement);
            }));
        }
    }
    ...
    var daysPassed = Math.round(timeDifference / (1e3 * 60 * 60 * 24));
    var daysElement = document.querySelector(".three__days");
    daysElement.textContent = daysPassed + " днів.";
    document.addEventListener("DOMContentLoaded", (function() {
        var infinityButton = document.getElementById("infinityButton");
        var infinitySign = document.querySelector(".infinitySign");
        infinityButton.addEventListener("click", (function() {
            infinityButton.style.opacity = "0";
            setTimeout((function() {
                infinityButton.style.display = "none";
                infinitySign.classList.add("visible");
                animateInfinity();
            }), 100);
        }));
        function animateInfinity() {
            ...
            setInterval((function() {
                angle += 1;
                infinitySign.style.transform = "rotate(" + angle + "deg)";
            }), animationSpeed);
        }
    }));
    ...
    document.addEventListener("fullscreenchange", (function() {
        if (document.fullscreenElement) wp.classList.remove("hidden"); else wp.classList.add("hidden");
    }));
    ...
    const correctPassword = "коханий";
    const loginError = document.getElementById("loginError");
    const loginButton = document.getElementById("loginButton");
    const pagePass = document.getElementById("pagePass");
    const loginNull = document.getElementById("loginNull");
    const passwordInput = document.getElementById("passwordInput");
    const storedPassword = localStorage.getItem("storedPassword");
    if (storedPassword === correctPassword) {
        pagePass.style.transform = "translate3d(0px, -100%, 0px)";
        pagePass.style.transition = "none";
    }
    ...
    function checkPassword() {
        ...
        if (enteredPassword === correctPassword) {
            ...
            passwordInput.blur();
        } else if (enteredPassword === "") loginNull.style.opacity = 1; else {
            loginError.style.opacity = 1;
            loginNull.style.opacity = 0;
        }
    }
    const section = document.querySelector(".seven");
    const options = {
        root: null,
        threshold: .7
    };
    ...
    function animateListItems() {
        const listItems = document.querySelectorAll(".seven__text li");
        const buttonLove = document.querySelector(".seven__btn");
        ...
        setTimeout((() => {
            buttonLove.classList.add("show");
        }), 5e3);
    }
    const sevenButton = document.getElementById("sevenButton");
    const pageSeven = document.getElementById("pageSeven");
    sevenButton.addEventListener("click", (function() {
        pageSeven.removeAttribute("data-no-event");
        pageSeven.classList.add("after-display-flex");
    }));
    const eightButtonFalse = document.getElementById("eightButtonFalse");
    eightButtonFalse.addEventListener("click", (function() {
        var screenWidth = window.innerWidth;
        var screenHeight = window.innerHeight;
        var randomX = Math.floor(Math.random() * (screenWidth - 100));
        var randomY = Math.floor(Math.random() * (screenHeight - 100));
        eightButtonFalse.style.position = "absolute";
        eightButtonFalse.style.left = randomX + "px";
        eightButtonFalse.style.top = randomY + "px";
    }));
    const pageEight = document.getElementById("pageEight");
    const eightButtonTrue = document.getElementById("eightButtonTrue");
    const textHidden = document.querySelector(".eight__hidden-1");
    const textHiddenTwo = document.querySelector(".eight__hidden-2");
    eightButtonTrue.addEventListener("click", (function() {
        pageEight.removeAttribute("data-no-event");
        textHidden.style.opacity = "1";
        textHiddenTwo.style.opacity = "1";
        eightButtonFalse.style.display = "none";
    }));
    const pageNine = document.getElementById("pageNine");
    const nineBtn = document.getElementById("nineBtn");
    const nineHidden = document.getElementById("nineHidden");
    const nineThx = document.querySelector(".nine__thanks");
    const nineArrow = document.querySelector(".nine__arrow");
    nineBtn.addEventListener("click", (function() {
        nineHidden.style.transition = "max-height 0.5s ease";
        nineHidden.style.maxHeight = nineHidden.scrollHeight + "px";
        setTimeout((function() {
            nineHidden.style.maxHeight = "0";
        }), 500);
